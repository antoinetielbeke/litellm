...
from litellm.types.llms.anthropic import AnthropicCompaction
...
_OPERATION: Final[AnthropicCompaction] = {"type": "summarize"}
REQUEST_KWARGS: Final[Mapping[str, object]] = MappingProxyType({"compaction": _OPERATION})
